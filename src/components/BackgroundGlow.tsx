...
// glowTopRight: pojok kanan atas (cx=100%, cy=0%), opacity 0.25
// glowBottomLeft: pojok kiri bawah (cx=0%, cy=100%), opacity 0.12
// Warna: #4A1772 — ungu sangat gelap, menyatu dengan background navy #0E1439
    ...
    <Svg style={StyleSheet.absoluteFill} pointerEvents="none">
      <Defs>
        <RadialGradient id="glowTopRight" cx="100%" cy="0%" r="60%">
          <Stop offset="0%" stopColor="rgba(74,23,114,0.25)" stopOpacity="1" />
          <Stop offset="70%" stopColor="rgba(74,23,114,0)" stopOpacity="0" />
        </RadialGradient>
        <RadialGradient id="glowBottomLeft" cx="0%" cy="100%" r="60%">
          <Stop offset="0%" stopColor="rgba(74,23,114,0.12)" stopOpacity="1" />
          <Stop offset="70%" stopColor="rgba(74,23,114,0)" stopOpacity="0" />
        </RadialGradient>
      </Defs>
